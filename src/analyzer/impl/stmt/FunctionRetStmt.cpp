...
namespace Semantic
{
        ...
        Analyzer &analyzer, AST::FunctionReturnStmt &node)
    {
        ...
        utils::todo("implement AST::FunctionReturnStmt analyzer");
    ...
    // static Core::FunctionEnvironment *resolve_fn_env(Core::Environment
    // *current)
    // {
    //     if (current == nullptr)
    //         return nullptr;
    ...
    // static void analyze_value(Analyzer &analyzer, AST::FunctionReturnStmt
    // &node,
    //                           AnalysisResult &result,
    ...
    //             {
    //                 result.value =
    //                 std::make_shared<Core::Value>(Core::null{}); return;
    //             }
